...
I denna guide ligger fokus på tydliga kodexempel \- förklarande texter hålls korta. Syftet är att guiden ska kunna användas praktiskt som en referens eller "kokbok" när man programmerar med Python.
